...
using EmsPlus.UI.CustomMenus.InspectMenu.Helpers;
using EmsPlus.UI.CustomMenus.InspectMenu.Menus;
...
using MainMenu = EmsPlus.UI.CustomMenus.InspectMenu.Menus.MainMenu;
