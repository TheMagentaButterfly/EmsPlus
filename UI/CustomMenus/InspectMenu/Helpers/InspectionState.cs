...
namespace EmsPlus.UI.CustomMenus.InspectMenu.Helpers   
{
    public class InspectionState
    {
        ...
        public void Update()
        {
            ...
            DiagnosticSlide = DiagnosticsExpanded
                ? Math.Min(DiagnosticSlide + step, 1f)
                : Math.Max(DiagnosticSlide - step, 0f);
        }

        public void ToggleDiagnostics() => DiagnosticsExpanded = !DiagnosticsExpanded;
