    ...
    public static partial class PatientMenuBuilder
    {
        ...
        private static void BuildKitMenu()
        {
            ...
            foreach (var kit in InventoryManager.PlacedKits)
            {
                ...
                AddInteractiveItem(KitMenu, $"~p~{string.Format(Localization.Get("ACT_PICK_UP_KIT_FORMAT", "Pick Up {0}"), kitName)}", Localization.Get("DESC_PICK_UP_KIT", "Pick up the kit"), true, () => {
