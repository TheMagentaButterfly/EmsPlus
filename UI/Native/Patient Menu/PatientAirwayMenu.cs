...
namespace EmsPlus.UI.Native.PatientMenu
{
    public static partial class PatientMenuBuilder
    {
        ...
        private static void BuildAirwayMenu()
        {
            ...
            AddInteractiveItem(AirwayMenu, $"~y~{Localization.Get("ACT_MANUAL_AIRWAY")}", Localization.Get("DESC_HEAD_TILT"), true, () => {
            ...
            AddInteractiveItem(AirwayMenu, $"~b~{Localization.Get("ACT_APPLY_OXYGEN_MASK")}", hasO2 ? Localization.Get("DESC_STANDARD_O2") : $"~r~{Localization.Get("REQ_OXYGEN_BAG")}", hasO2, () => {
            ...
            AddInteractiveItem(AirwayMenu, $"~b~{Localization.Get("ACT_APPLY_NRB_MASK")}", hasO2 ? Localization.Get("DESC_HIGH_FLOW_O2") : $"~r~{Localization.Get("REQ_OXYGEN_BAG")}", hasO2, () => {
            ...
            AddInteractiveItem(AirwayMenu, $"~b~{Localization.Get("ACT_USE_BVM")}", hasO2 ? Localization.Get("DESC_ASSIST_VENTILATIONS") : $"~r~{Localization.Get("REQ_OXYGEN_BAG")}", hasO2, () => {
