    ...
    public static class Localization
    {
        ...
        private static void CreateDefaultFile(string path)
        {
            using (StreamWriter w = new StreamWriter(path))
            {
                ...
                w.WriteLine("ACT_ATTACH_BP_CUFF=Attach BP Cuff");
                w.WriteLine("ACT_ATTACH_BP_CUFF_DESC=Apply NIBP cuff");
                w.WriteLine("ACT_ATTACH_ECG_LEADS=Attach ECG Leads");
                w.WriteLine("ACT_ATTACH_ECG_LEADS_DESC=Connect ECG monitoring leads");
                w.WriteLine("ACT_ATTACH_SPO2_PROBE=Attach SpO2 Probe");
                w.WriteLine("ACT_ATTACH_SPO2_PROBE_DESC=Attach pulse oximeter probe");
                ...
                w.WriteLine("ACT_DELEGATE_TREATMENT=Order: Delegate Treatment");
                w.WriteLine("ACT_DISMISS_UNIT=~r~Dismiss Unit");
                w.WriteLine("ACT_DRIVE_TO_HOSPITAL=Order: Drive to Hospital");
                ...
                w.WriteLine("ACT_ORDER_LOAD_ONLY=Order: Load Patient Only");
                w.WriteLine("ACT_ORDER_TRANSPORT=Order: Transport Patient");
                ...
                w.WriteLine("ACT_REMOVE_BP_CUFF=Remove BP Cuff");
                w.WriteLine("ACT_REMOVE_BP_CUFF_DESC=Remove NIBP cuff");
                w.WriteLine("ACT_REMOVE_ECG_LEADS=Remove ECG Leads");
                w.WriteLine("ACT_REMOVE_ECG_LEADS_DESC=Disconnect ECG monitoring leads");
                w.WriteLine("ACT_REMOVE_SPO2_PROBE=Remove SpO2 Probe");
                w.WriteLine("ACT_REMOVE_SPO2_PROBE_DESC=Remove pulse oximeter probe");
                ...
                w.WriteLine("CAT_SEP_DEFIB=~c~=== MONITOR & DEFIBRILLATOR ===");
                ...
                w.WriteLine("DESC_AMBULANCE=Request a ground ambulance unit.");
                ...
                w.WriteLine("DESC_DISMISS_UNIT=Unit will return to their ambulance and leave the scene.");
                ...
                w.WriteLine("DESC_FIRE_DEPARTMENT=Request a fire engine unit.");
                ...
                w.WriteLine("DESC_LOCAL_PATROL=Request a local police patrol unit.");
                ...
                w.WriteLine("DISPATCH_BACKUP_NOTIF=~g~Requesting ~w~an additional backup unit from dispatch.");
                ...
                w.WriteLine("ITEM_SELECT_PATIENT=Select Patient");
                w.WriteLine("ITEM_SELECT_UNIT=Select Unit");
                ...
                w.WriteLine("LBL_AMBULANCE=Ambulance");
                ...
                w.WriteLine("LBL_FIRE_DEPARTMENT=Fire Department");
                w.WriteLine("LBL_LOCAL_PATROL=Local Patrol");
                w.WriteLine("LBL_RESPONSE_TYPE=Response Type");
                ...
                w.WriteLine("MENU_BACKUP_COLORED=Backup");
                w.WriteLine("MENU_COMMAND_COLORED=Backup Manager");
                ...
                w.WriteLine("MENU_RANK_LABEL=Title / Rank");
                w.WriteLine("MENU_STATION_DESC=Select the station you are operating out of.");
                w.WriteLine("MENU_STATION_LABEL=Station");
                w.WriteLine("MENU_STATION_SUBTITLE=Select Station & Rank");
                w.WriteLine("MENU_STATION_TITLE=Station Services");
                ...
                w.WriteLine("SUBTITLE_BACKUP=Request Resources");
                w.WriteLine("SUBTITLE_COMMAND=Manage AI Resources");
