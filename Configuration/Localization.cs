    ...
    public static class Localization
    {
        ...
        private static void CreateDefaultFile(string path)
        {
            using (StreamWriter w = new StreamWriter(path))
            {
                ...
                w.WriteLine("ACT_REQ_AMBULANCE=Request Ambulance");
                w.WriteLine("ACT_REQ_FIRE=Request Fire");
                w.WriteLine("ACT_REQ_HELI=Request Air Medevac");
                w.WriteLine("ACT_REQ_POLICE=Request Police");
