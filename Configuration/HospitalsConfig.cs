            ...
            try
            {
                ...
                foreach (XElement el in doc.Descendants("Location"))
                {
                    if (el.Attribute("x") != null && el.Attribute("y") != null && el.Attribute("z") != null)
                    {
                        ...
                        Locations.Add(new HospitalLocation { Position = new Vector3(x, y, z), Name = name });
                        count++;
                    }
                }
        ...
        private void CreateDefaultFile()
        {
            XDocument defaultDoc = new XDocument(
                new XElement("Hospitals",
                    ...
                    // Default GTA V Hospitals
                    new XElement("Location", new XAttribute("x", "351.949"), new XAttribute("y", "-588.247"), new XAttribute("z", "74.166"), new XAttribute("name", "Pillbox Hospital Helipad")),
                    ...
                    new XElement("Location", new XAttribute("x", "299.316"), new XAttribute("y", "-1453.558"), new XAttribute("z", "46.509"), new XAttribute("name", "Center LS Mecial Center Helipad 1")),
                    new XElement("Location", new XAttribute("x", "313.383"), new XAttribute("y", "-1465.261"), new XAttribute("z", "46.509"), new XAttribute("name", "Center LS Mecial Center Helipad 2")),
